...
import 'join_name_page.dart';

class Join_Page extends StatelessWidget {
  const Join_Page({Key? key});
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Name_group_Page()));
                  },
                ),
              ),
            ],
