...
class Name_group_Page extends StatelessWidget {
  const Name_group_Page({Key? key});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: TextField(
              controller: TextEditingController(text: 'เรารักต้นไม้'),
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Home1_Page()));
                  },
                ),
              ),
            ],
